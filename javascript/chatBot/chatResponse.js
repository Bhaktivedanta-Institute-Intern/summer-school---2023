...
function response(userInput){
    if(userInput.toLocaleLowerCase() == 'I Have Registered but did not get the confirmation mail'.toLocaleLowerCase()){
        let ans='Please wait for 24 hours you will get the mail';
return ans;
    }
    else if(userInput.toLocaleLowerCase() == 'How I can Register'.toLocaleLowerCase()){
        let ans='Need to go the Register page';
        return ans;
    }
    else if(userInput.toLocaleLowerCase() == 'How I Can Reach the venue from my Location'.toLocaleLowerCase()){
        let ans='Will be update soon';
        return ans;
    }
    else if(userInput.toLocaleLowerCase() == 'Who are the Speakers'.toLocaleLowerCase()){
